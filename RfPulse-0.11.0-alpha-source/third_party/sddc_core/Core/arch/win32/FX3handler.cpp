...
bool fx3handler::isSuperSpeed() const
{
	// Close() (llamado al final de Enumerate()) libera el handle pero no
	// borra bSuperSpeed/BcdUSB, asi que este valor sigue reflejando el
	// ultimo Open() de fx3dev aunque ya este cerrado.
	return (fx3dev != nullptr) && fx3dev->bSuperSpeed;
}
