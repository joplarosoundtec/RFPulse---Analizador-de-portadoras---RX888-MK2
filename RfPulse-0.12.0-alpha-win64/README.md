...
- Espectro en tiempo real con traza actual, promedio configurable, max-hold,
  ...
  para no arrastrar datos de una sintonización anterior. El cartel del pico
  principal, además, se suaviza por separado del propio marcador para que
  ni siquiera la caja de texto "dé botes" en pantalla.
...
- Icono propio de aplicación (barra de título, barra de tareas y el propio
  ...
  proyecto, mientras se abre el dispositivo SDR. El logo se localiza
  siempre junto al propio ejecutable, sin depender del directorio de
  trabajo desde el que se lance (doble clic, acceso directo, depurador...).
...
Esta es una versión **0.12.0-alpha**: funcional y probada con hardware real
